...
CREATE TABLE `quartz` (
  ...
  `class_name` varchar(255) DEFAULT NULL COMMENT '任务全类名',
  `state` tinyint(4) DEFAULT NULL COMMENT '任务状态 1: 运行状态；',
  `job_cron` varchar(255) DEFAULT NULL COMMENT '任务定时表达式',
  `is_open` tinyint(4) DEFAULT NULL COMMENT '是否启动 1：启动；0：不启动',
